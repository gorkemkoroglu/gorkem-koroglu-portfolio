...
export function WorkHighlights() {
  ...
  return (
    <section id="highlights" className="py-24 bg-card/20 border-y border-border/50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl font-bold font-heading mb-6">{h.heading}</h2>
          <div className="h-px w-16 bg-primary rounded-full mb-6" />
          <p className="text-foreground/70 max-w-3xl leading-relaxed text-base">{h.intro}</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {h.items.map((item, idx) => (
            <motion.div
              ...
              className="group bg-background border border-border/60 rounded-2xl p-6 hover:border-primary/30 hover:shadow-[0_0_24px_rgba(0,200,200,0.05)] transition-all duration-300"
            >
